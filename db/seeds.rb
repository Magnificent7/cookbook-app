Recipe.create!([
  ...
  {title: "Test", ingredients: "Test", directions: "Test", image: nil, prep_time: 12, user_id: 1}
])
User.create!([
  {first_name: "dani", last_name: "zaghian", email: "dani@actualize.co", password_digest: "$2a$10$n1/3KfCPiQ9XNYwFs/zN8uFw9G5IaaN6UmSOCt3BCEndYgM./w9Gq"}
])
